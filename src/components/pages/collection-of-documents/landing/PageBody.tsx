...
const PageBody = ({
  ...
  return (
    <div css={[tw`pb-xl`]}>
      <CustomSection components={landingSections.firstSectionComponents} />
      <CollectionsSection
        collections={landingSections.collections}
        parentCurrentLanguageId={siteLanguage.id}
      />
      <RecordedEventsSection
        recordedEvents={landingSections.recordedEvents}
        parentCurrentLanguageId={siteLanguage.id}
      />
      <CustomSection components={landingSections.secondSectionComponents} />
    </div>
  )
}
